...
if TYPE_CHECKING:
    ...
    from timecolor.parallel import ParallelBackendType


def perform_patches_for_training(args: "BaseArgsType", parallel_backend: "ParallelBackendType") -> None:
    # To avoid circular imports
    from timecolor.config import ModelType, TrainingType
...
def patch_scaled_dot_product_attention():
    from timecolor.models.attention_dispatch import attention_dispatch
